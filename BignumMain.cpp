/*  "Sahand Alitanloo"  */
/*  "try to find a reason to laugh because there are plenty to cry"  */
...
inline int bpow(int t,int n){int ans=1;while(n>0){if(n&1)ans=(ans*t)%mod;t=(t*t)%mod,n>>=1;}return ans;}
